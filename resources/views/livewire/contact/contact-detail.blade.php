    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-blue-700/20 p-6">
                ...
                <!-- Search -->
                <div class="mb-4">
                    <input type="text" wire:model.live="searchQuery" placeholder="Search contacts..." class="w-full px-4 py-2 rounded-lg bg-slate-700 text-white placeholder-gray-500 border border-blue-700/20 focus:border-blue-700 focus:outline-none transition">
                </div>
