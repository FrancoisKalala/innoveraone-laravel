                ...
                <div>
                    ...
                    @if($showScheduleInput)
                        <div class="mt-3 animate-fade-in">
                            <label for="publishAtModal" class="block text-sm font-medium text-gray-300 mb-1">Publish At</label>
                            <input type="datetime-local" id="publishAtModal" wire:model="publishAt" class="w-full px-4 py-2 rounded-lg bg-slate-700 text-white border border-blue-700/20 focus:border-blue-700 focus:outline-none transition text-sm">
