<div class="space-y-6">
    ...
    <!-- Album Header -->
    <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-blue-500/20 overflow-hidden">
        ...
        <div class="px-6 md:px-8 py-8">
            <div class="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-400 mb-3">by <a href="#" class="hover:text-blue-300 font-semibold">{{ $selectedAlbum->user->name }}</a></p>
                ...
                @if(auth()->id() === $selectedAlbum->user_id)
                    <div class="flex gap-2">
                        <a href="{{ route('albums', ['edit' => $selectedAlbum->id]) }}" class="px-6 py-2 bg-gradient-to-r from-blue-600 to-black text-white rounded-lg font-semibold hover:shadow-lg transition">
                            Edit Album
                        </a>
    ...
    <!-- Posts Grid -->
    <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-blue-500/20 p-6">
        ...
        @else
            <div class="text-center py-16">
                ...
                @if(auth()->id() === $selectedAlbum->user_id)
                    <a href="{{ route('dashboard') }}" class="inline-block px-6 py-2 bg-gradient-to-r from-blue-600 to-black text-white rounded-lg font-semibold hover:shadow-lg transition">
                        Create Post
                    </a>
                @endif
            </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-blue-500/20 p-6">
            ...
            <p class="text-4xl font-bold bg-gradient-to-r from-blue-400 to-black bg-clip-text text-transparent">{{ $selectedAlbum->views()->count() }}</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-blue-500/20 p-6">
            ...
            <p class="text-4xl font-bold bg-gradient-to-r from-blue-400 to-black bg-clip-text text-transparent">{{ $selectedAlbum->favorites()->count() }}</p>
        </div>
