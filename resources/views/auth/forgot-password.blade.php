...
<head>
    ...
    <title>Forgot Password - InnoveraOne</title>
    ...
    <div class="glass rounded-3xl p-8 shadow-2xl animate-in delay-1">
      ...
      <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
        ...
        <div>
          ...
          <input type="email" name="email" required autofocus class="w-full px-5 py-3.5 rounded-xl bg-slate-700/60 text-white placeholder-gray-400 border-2 border-purple-500/30 focus:border-purple-400 focus:outline-none focus:ring-4 focus:ring-purple-500/20 transition" placeholder="you@innovera.com" />
        </div>
        <button type="submit" class="w-full py-3.5 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 text-white font-bold rounded-xl hover:shadow-2xl hover:shadow-purple-500/50 transition">Send Reset Link</button>
      </form>
