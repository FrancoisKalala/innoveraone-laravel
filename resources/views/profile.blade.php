                ...
                <div class="max-w-6xl mx-auto px-4 py-8">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Expired Posts -->
                            <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-red-700/20 p-6">
                                <h3 class="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                    <svg class="w-5 h-5 text-red-600" fill="currentColor" viewBox="0 0 24 24"><path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                    Expired Posts
                                </h3>
                                <p class="text-gray-400 text-sm mb-4">View and manage your deleted posts</p>
                                <a href="{{ route('expired-posts') }}" class="block w-full py-2 text-center bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition">
                                    View Deleted Posts
                                </a>
                            </div>
